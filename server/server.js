...
//     console.log('Analysis results updated:', { peakTime, popularTurfs });
// };
...
//     // Convert booking start time and duration to a time range in minutes
//     const bookingStart = moment(`${date} ${time}`, 'YYYY-MM-DD HH:mm');
//     const bookingEnd = moment(bookingStart).add(duration, 'hours'); // bookingEnd time in hours

//     try {
//         // Fetch existing bookings for the turf on the same date
...
//         // Save the new booking if no overlap is detected
